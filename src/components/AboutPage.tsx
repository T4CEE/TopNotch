  ...
  return (
    <div className="text-black mt-[100px] px-4">
            ...
            <div>
              ...
              <h1 className='text-[25px] mt-3 xl:mt-7 font-semibold'> Mision</h1>
              <h1 className='mt-2 '>
              ...
              <h1 className='text-[25px] mt-6 xl:mt-7 font-semibold'> Background</h1>
              <h1 className='mt-2 '>
            ...
            <div className="ml-3 mt-3">
                <ul className=" list-disc list-outside ml-3">
                  <li>Find disaster assistance that meets your personal needs.</li>
                  <li>
            ...
            <div className="ml-3 mt-3">
                <ul className=" list-disc list-outside ml-3">
                  <li>Evacuate or shelter in place.</li>
                  <li>
              ...
              <h1 className='text-[E-Government5px] mt-3 xl:mt-7 font-semibold'> E-Government</h1>
              <h1 className='mt-2 '>
            ...
            <div className="ml-3 mt-3">
                <ul className=" list-disc list-outside ml-3">
                  <li>Streamline access to services.</li>
                  <li>
